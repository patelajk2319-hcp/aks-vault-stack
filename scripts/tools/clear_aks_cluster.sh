...
# Step 2: Destroy VSO
# -----------------------------------------------------------------------------
echo -e "${BLUE}Step 2: Destroying Vault Secrets Operator...${NC}"
...
# -----------------------------------------------------------------------------
# Step 3: Destroy Vault
# -----------------------------------------------------------------------------
echo -e "${BLUE}Step 3: Destroying Vault infrastructure...${NC}"
...
echo ""
echo -e "${YELLOW}Note: AKS cluster infrastructure is still running${NC}"
echo ""
echo -e "${YELLOW}Next steps:${NC}"
echo -e "  Run ${BLUE}task up${NC} to redeploy Vault to the existing cluster"
echo -e "  Run ${BLUE}task nuke${NC} to destroy all infrastructure including AKS"
echo ""
